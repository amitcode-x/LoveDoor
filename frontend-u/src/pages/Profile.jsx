          ...
          {quickStats.map((stat, idx) => (
            ...
            >
              ...
              <div className="relative z-10">
                <div
                  className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br ${stat.color} flex items-center justify-center mb-3 shadow-lg group-hover:shadow-xl transition-all duration-500 group-hover:scale-110`}
                >
              ...
              {/* Bottom Glow */}
              <div
                className={`absolute -bottom-2 left-1/2 -translate-x-1/2 w-3/4 h-3 bg-gradient-to-r ${stat.color} opacity-0 group-hover:opacity-30 blur-xl rounded-full transition-all duration-500`}
              ></div>
            </div>
          ))}
        </div>
            ...
            {navItems.map((item, idx) => (
              ...
              >
                ...
                <div className="relative z-10 flex items-center gap-4">
                  <div
                    className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-gradient-to-br ${item.color} flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-500 flex-shrink-0`}
                  >
                ...
                {/* Bottom Glow */}
                <div
                  className={`absolute -bottom-2 left-1/2 -translate-x-1/2 w-3/4 h-3 bg-gradient-to-r ${item.color} opacity-0 group-hover:opacity-30 blur-xl rounded-full transition-all duration-500`}
                ></div>
              </div>
            ))}
          </div>
                ...
                {!editMode && (
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-xl p-4 border border-white/40 hover:bg-white/70 transition-all duration-300">
                      ...
                      <p className="text-gray-800 font-bold text-sm sm:text-base pl-11 break-all">
                        {profile.email}
                      </p>
                    </div>
