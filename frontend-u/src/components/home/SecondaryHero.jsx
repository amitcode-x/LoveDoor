      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div
            ...
            from-white/60 via-pink-100/50 to-orange-100/50 -z-20"
          ></div>
          ...
          {/* ⭐ CONTENT CENTERED */}
          <div
            className="relative z-20 h-full w-full flex flex-col items-center justify-center 
          ...
          >
            ...
            {/* DESCRIPTION */}
            <p
              className="max-w-2xl text-sm sm:text-base md:text-lg font-medium 
          ...
          <div
            ...
            from-pink-300/40 to-orange-300/40 rounded-full blur-3xl"
          ></div>

          <div
            className="absolute bottom-0 left-0 w-48 h-48 bg-gradient-to-tr 
            from-red-300/40 to-yellow-300/40 rounded-full blur-3xl"
          ></div>
        </div>
      </div>
    </section>
...
export default memo(SecondaryHero);
