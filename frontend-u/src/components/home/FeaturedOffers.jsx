...
function FeaturedOffers({ offers }) {
  ...
  return (
    <section className="w-full">
      ...
      <div
        className="relative rounded-xl md:rounded-2xl p-3 sm:p-4 md:p-5 shadow-2xl 
      ...
      >
        ...
        <div
          ...
          rounded-xl md:rounded-2xl -z-10"
        ></div>

        {/* Glow Effects */}
        <div
          className="absolute top-0 right-0 w-32 h-32 bg-gradient-to-br 
          from-pink-300/60 to-orange-300/70 rounded-full blur-3xl -z-10"
        ></div>
        <div
          className="absolute bottom-0 left-0 w-40 h-40 bg-gradient-to-tr 
          from-red-300/70 to-yellow-300/70 rounded-full blur-3xl -z-10"
        ></div>
        ...
        >
          ...
          {offers.map((offer) => (
            ...
            >
              {/* ⭐ IMAGE */}
              <div
                className="relative w-[170px] h-[170px] sm:w-[190px] sm:h-[190px] mx-auto
              ...
              >
                ...
                {/* Bottom Glow */}
                <div
                  className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-3/4 h-5 
              ...
              <div className="mt-3 flex flex-col items-center">
                <h3
                  className="text-gray-800 text-xs sm:text-2xl leading-tight 
